...
INSERT INTO "new_products" ("createdAt", "currency", "currentStock", "description", "id", "images", "isActive", "laborCost", "margin", "materialCost", "maxStock", "minStock", "name", "overheadCost", "productionTime", "sellingPrice", "sku", "specifications", "tags", "totalCost", "unit", "updatedAt") SELECT "createdAt", "currency", "currentStock", "description", "id", "images", "isActive", "laborCost", "margin", "materialCost", "maxStock", "minStock", "name", "overheadCost", "productionTime", "sellingPrice", "sku", "specifications", "tags", "totalCost", "unit", "updatedAt" FROM "products";
DROP TABLE "products";
